...
filter(wine, rownames(wine) == as.integer(clust1[2])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust1[3])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust1[4])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust1[5])) %>% tbl_df %>% print(n = 15)
...
filter(wine, rownames(wine) == as.integer(clust2[2])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust2[3])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust2[4])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust2[5])) %>% tbl_df %>% print(n = 15)
```
...
filter(wine, rownames(wine) == as.integer(clust3[2])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust3[3])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust3[4])) %>% tbl_df %>% print(n = 15)
filter(wine, rownames(wine) == as.integer(clust3[5])) %>% tbl_df %>% print(n = 15)
```
